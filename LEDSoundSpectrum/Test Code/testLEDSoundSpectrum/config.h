 ...
 **/
#include "heat_scale.h"  // for array of heatscale hex colors
...
//#define __DEBUG_AUDIO__ (1)  // print out raw ADC readings for audio samples
//#define __DEBUG_FFT__ (1)  // print out FFT results
//#define __DEBUG_LED__ (1)  // print out color scale indexes mapped to FFT data

// Length of FFT Real data (Real half of FFT data)
// #define __FFT_N_REAL_32__ (1) 
#define __FFT_N_REAL_64__ (1)
...
// #define USER_SET_SAMPLE_MILLIS      20
#define DEFAULT_DELAY_MILLIS        20
#define NUM_LEDS                    128
#define DATA_LED_SCALE              2  // the number of LEDs that represent 
                                       // one spectrum data point
#define NUM_COLORS                  32
#define PALETTE_ARRAY               ORANGE_SCALE_HEX32
#define PALETTE_TYPE                CRGBPalette32
...
#define MAX_ADC_VAL (double) 0x3FFF
#endif  // __RA4M1__
...
//// Settings for 128-length FFT data (64 real data values) /////////////////////
#ifdef __FFT_N_REAL_64__
/* FreeRTOS settings
 */
// Task stack depths
#define STACK_DEPTH_SETUP           1 << 7
#define STACK_DEPTH_DELAY           1 << 7
#define STACK_DEPTH_AUDIO           (1 << 8) + (1 << 6)
#define STACK_DEPTH_FFT             1 << 8
#define STACK_DEPTH_LED             1 << 7
